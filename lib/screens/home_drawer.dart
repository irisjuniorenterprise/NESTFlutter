...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  var name;
  var imageProfile;
  getEagleFullName() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    var firstName = preferences.getString('eagleFName');
    var lastName = preferences.getString('eagleLName');
    var fullName = firstName! + ' ' + lastName!;
    print(fullName);
    name = fullName;
  }
  getEagleProfileImage() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    var image = preferences.getString('eagleImg');
    print(image);
    imageProfile = image;
  }
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        ...
        labelName: 'IRIS Library',
        icon: const Icon(Icons.library_books),
      ),
      DrawerList(
        index: DrawerIndex.Blame,
        labelName: 'Blames',
        icon: const Icon(Icons.error),
      ),
      DrawerList(
        index: DrawerIndex.Contact,
        labelName: 'IRIS Contact',
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network('https://api.irisje.tn/${imageProfile}' , fit: BoxFit.cover,),
                            ),
                          ),
                        ),
                      );
  ...
  Future<String?> getEagleImage() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
     var image = preferences.getString('eagleImg');
    return image;
